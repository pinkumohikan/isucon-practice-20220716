...
stop-services:
	...
	ssh isucon111q-02 "sudo systemctl stop isucondition.go"
	ssh isucon111q-03 "sudo systemctl stop mysql"

start-services:
	ssh isucon111q-03 "sudo systemctl start mysql"
	sleep 5
	sudo systemctl start isucondition.go
	scp ./go/isucondition isucon111q-02:/home/isucon/webapp/go/isucondition
	ssh isucon111q-02 "sudo systemctl start isucondition.go"
...
save-log: 
	...
	ssh isucon111q-03  "sudo cp -p /var/log/mysql/mysql-slow.log  /home/isucon/mysql-slow.log && sudo chmod 777 /home/isucon/mysql-slow.log"
	scp -C isucon111q-03:/home/isucon/mysql-slow.log  /home/isucon/logs/$(TS)/mysql-slow.log
